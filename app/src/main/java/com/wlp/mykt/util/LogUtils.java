...
import com.wlp.mykt.base.BaseApplication;
...
public class LogUtils {
    ...
    public static void writeLog2File(final Object log) {
        ...
        int isPermission = ContextCompat.checkSelfPermission(BaseApplication.getInstance(), Manifest.permission.WRITE_EXTERNAL_STORAGE);
